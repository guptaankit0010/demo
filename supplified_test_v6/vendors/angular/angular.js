...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol) {
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials, responseType) {
    ...
    function completeRequest(callback, status, response, headersString) {
      // URL_MATCH is defined in src/service/location.vendors
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * <pre>
     * <file src="./test/ng/rootScopeSpec.vendors" tag="docs1" />
     * </pre>
     *
     * # Inheritance
...
function $SceDelegateProvider() {
  ...
  this.$get = ['$log', '$document', '$injector', '$$urlUtils', function(
     ...
     *   resourceUrl, html, vendors and css.
...
function $SceProvider() {
   ...
   * sce.vendors and sceSpecs.vendors would need to be aware of this detail.
   */
